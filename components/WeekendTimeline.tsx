...
export default function WeekendTimeline() {
  ...
  return (
    ...
    >
        ...
        {/* Divider */}
        <div className="w-full h-px bg-gradient-to-r from-transparent via-gold/25 to-transparent mb-16 animate-on-scroll" aria-hidden="true" />
        ...
        <div className="relative">
          ...
          <ol className="grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-8" aria-label={t('weekend.title')}>
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div
                    ...
                    aria-hidden="true"
                  >
                    <span className={`font-display italic font-light select-none text-lg leading-none ${highlight ? 'text-gold' : 'text-dark/50'}`}>{icon}</span>
                  </div>
