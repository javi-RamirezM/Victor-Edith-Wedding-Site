...
export default function GuestList() {
  ...
  const totalGuests = attendees.reduce(
    (sum, a) => sum + (a.total_asistentes || 1),
    0,
  );
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 gap-px mb-16 animate-on-scroll bg-gold/20">
          {[
            ...
            <div key={label} className="bg-dark text-center py-8 px-4">
              <span
                className="block font-display italic text-gold text-gold-contrast font-light leading-none"
        ...
        {loading ? (
          <div className="flex justify-center py-12">
            <div
              className="w-7 h-7 border border-gold/30 border-t-gold rounded-full animate-spin"
          ...
          <div className="text-center py-12 animate-on-scroll">
            <Heart
              className="w-8 h-8 text-gold/20 mx-auto mb-4"
              aria-hidden="true"
            />
